// package cr.ac.una.unaplanillal2025.util;
//
...
//
// static ChangeListener<Toggle> changeListener = (ObservableValue<? extends
...
// }
//
// public static <T> void bindToggleGroupToProperty(final ToggleGroup
// toggleGroup, final ObjectProperty<T> property) {
// // Check all toggles for required user data
// toggleGroup.getToggles().forEach(toggle -> {
// if (toggle.getUserData() == null) {
// throw new IllegalArgumentException("The ToggleGroup contains at least one
// Toggle without user data!");
// }
// });
...
// changeListener = (ObservableValue<? extends Toggle> observable, Toggle
...
// }
//
// public static <T> void unbindToggleGroupToProperty(final ToggleGroup
// toggleGroup, final ObjectProperty<T> property) {
