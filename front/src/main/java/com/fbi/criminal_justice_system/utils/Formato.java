...
// if (validDoubleText.matcher(c.getControlNewText().replace(",",
// "")).matches()) {
// return c;
// } else {
// return null;
...
// }
// if (maxLength > 0) {
// if (((TextInputControl) c.getControl()).getLength() >= maxLength &&
// !c.isDeleted()) {
// return null;
// }
...
// }
//
// if (((TextInputControl) c.getControl()).getLength() >= length &&
// !c.isDeleted()) {
// return null;
// }
